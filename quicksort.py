...
def quick_sort(data, head, tail, drawData, timeTick):
	if head < tail:
		paritionIdx = partition(data, head, tail, drawData, timeTick)

		#left partition
		quick_sort(data, head, paritionIdx-1, drawData, timeTick)

		#right partition
		quick_sort(data, paritionIdx+1, tail, drawData, timeTick)
