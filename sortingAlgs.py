...
minEntry = Scale(UI_frame, from_=0, to=10, resolution=0.2, orient=HORIZONTAL,label="Min Value")
minEntry.grid(row=1,column=1,padx=5,pady=5)

maxEntry = Scale(UI_frame, from_=10, to=100, resolution=0.2, orient=HORIZONTAL,label="Max Value")
